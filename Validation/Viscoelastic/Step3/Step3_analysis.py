...
from Step3 import  inter_arc_distance, run, phi0s,  base_path, kws, kws_baseline, kws_middle, kws_outer, kws_double, get_inter_edges, L0_T1s


fontsize=14
from Step3 import depth_timeline, intercalations, run, phi0s,  base_path, kws_baseline,  clinton_double, final_angle, L0_T1s, clinton_middle, clinton_outer, final_inter_arc_depth, final_depth, final_lumen_depth
from Step3 import naught_middle_remodel, naught_outer_remodel, naught_double_remodel, extension_timeline
from Step3 import kws_baseline, kws_outer, kws_middle, kws_double
...
if __name__ == '__main__':
        ...
        plt.legend(loc='upper left', bbox_to_anchor=(1.05, .975))
        plt.tight_layout() 
        plt.savefig('invagination_depth_vs_rest_length_zeroed_pressure.pdf',dpi=200)
        plt.show()
