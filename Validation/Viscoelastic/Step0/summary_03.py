...
if __name__ == '__main__':
    ...
    for lvl in (0,1,2):
        c=colors[lvl]
        adv=np.load(f'viscoelastic_cable_advantange_127_level_{lvl}.npy')
        adv_no_cable=np.load(f'viscoelastic_advantange_127_level_{lvl}.npy')
    ...
    plt.tight_layout()
    plt.savefig(f'viscoelastic_advantanges_127.pdf',dpi=200)
    plt.show()
