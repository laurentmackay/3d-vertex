...
# 
    ...
    if arcs==2:
        pattern='peripheral_outer_'+pattern
...
def plot_results(forces,results):
    ...
    plt.tight_layout()
    plt.xlim((0,phi[-1]))
    plt.savefig(f'peripheral_outer_belt_contraction_127.pdf',dpi=200)
    plt.show()
    ...
    plt.savefig(f'peripheral_outer_belt_contraction_time_127.pdf',dpi=200)
    plt.show()
