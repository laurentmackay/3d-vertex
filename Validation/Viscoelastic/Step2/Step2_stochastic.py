...
from VertexTissue.globals import inter_edges_middle, inter_edges_outer, inner_arc, outer_arc, l_apical, pit_strength, myo_beta
...
def run(phi0, remodel=True, cable=True, L0_T1=0.0, verbose=False, belt=True, intercalations=0, outer=False, double=False, rep=0.0):
    ...
    squeeze = SG.arc_pit_and_intercalation(G, belt, t_1=t_start, inter_edges= [], t_intercalate=t_start, pit_strength=sigma)
...
kws_middle = dict_product({'intercalations':[4, 6, 8, 180], 'remodel':[True,False], 'L0_T1':L0_T1s, 'rep':reps})
kws_outer = dict_product({'intercalations':[4, 6, 8, 180], 'outer':True, 'remodel':[True,False], 'L0_T1':L0_T1s, 'rep':reps})
kws_double = dict_product({'intercalations':[4, 6, 8, 180], 'outer':True, 'double':True, 'remodel':[True,False], 'L0_T1':L0_T1s, 'rep':reps})
...
if __name__ == '__main__':
    ...
    # run(0.3, L0_T1=0, intercalations=2000, outer=True, double=True,verbose=True)
