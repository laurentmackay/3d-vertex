...
def run(phi0, remodel=True, cable=True, L0_T1=0.0, verbose=False, belt=True, intercalations=0, outer=False, double=False, viewable=viewable, stochastic=False, press_alpha=press_alpha):
...
#     sweep(phi0s, run, kw=kws, savepath_prefix=base_path, overwrite=False, pre_process=foo)
    run(1.0, L0_T1=l_apical, intercalations=8, remodel=False,   verbose=True, viewable=True, outer=False, stochastic=False)
