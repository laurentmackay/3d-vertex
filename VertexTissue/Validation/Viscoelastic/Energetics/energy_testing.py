...
def run(force, visco=False,  phi0=1.0, level=0, arcs=2, cable=True, continuous_pressure=False,
    ...
    squeeze = SG.arcs_pit_and_intercalation(G, arc_list, t_belt=3500, inter_edges=inter_edges,  t_intercalate=375 if pit_strength else 0, t_1=375  if pit_strength else 0, intercalation_strength=force,
