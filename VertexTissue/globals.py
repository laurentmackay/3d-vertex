...
inner_arc_discont = [[85, 86, 23, 26, 25, 24, 92, 91],
                     [82, 83, 18, 19, 20, 21, 88, 89]]

outer_arc_discont2 = [[48, 119, 118, 187, 186, 249, 248],
                     [281, 280, 273, 272, 274, 283, 284],
                     [251, 252, 189, 190, 121, 122, 53],
                     [54, 128, 127, 196, 195, 258, 257],
                     [290, 289, 278, 277, 276, 287, 286],
                     [255, 254, 193, 192, 125, 124, 51]]

outer_arc_discont = [[121, 122, 53, 56, 55, 54, 128, 127],
                     [183, 246, 245, 302, 301, 290, 289, 278],
                     [276, 287, 286, 299, 298, 243, 242, 181],
                     [125, 124, 51, 50, 49, 48, 119 , 118],
                     [174, 237, 236, 293, 292, 281, 280, 273],
                     [274, 283, 284, 295, 296, 239, 240, 177]]
...
# These arcs seem to be off-center, not sure what to do with them but probably a relic of earlier Clinton work
# arc1_1 = [252, 189, 178, 109, 98, 97, 86, 85, 73, 72, 144, 142, 212, 210, 273, 272, 330, 332]
# arc2_1 = [122, 53, 46, 45, 44, 35, 34, 25, 24, 15, 14, 5, 4, 3, 2, 8, 69, 82, 151, 162, 225, 236, 293, 292, 343, 342]
# arc3_1 = [196, 195, 184, 183, 172, 171, 160, 159, 148, 147, 146, 157, 156, 89, 88, 21, 20, 19, 28, 95, 106, 175, 186, 249]
# arc4_1 = [314, 313, 302, 301, 290, 289, 278, 277, 276, 287, 286, 299, 298, 243, 242, 181, 180, 113, 112, 41, 40, 39, 48, 119]
